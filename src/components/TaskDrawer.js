        ...
        <div className="flex flex-row-reverse w-full z-10 ease-in-out transition-all bg-black/30 absolute inset-0 before:opacity-75 after:opacity-100 duration-700">
          ...
          >
            ...
            <div className="flex flex-col h-full gap-4 px-16 py-10">
              ...
              <div className="text-slate-700 font-semibold text-lg h-screen mb-10 flex flex-col gap-3">
                Description: <br />
                <textarea
                  className="w-full h-full bg-slate-100 font-normal p-3 rounded text-slate-700 placeholder:font-normal text-sm outline-none"
